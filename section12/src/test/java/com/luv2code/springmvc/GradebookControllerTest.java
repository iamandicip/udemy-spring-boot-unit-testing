...
public class GradebookControllerTest {
    ...
    @Test
    public void deleteStudentHttpRequestNotExists() throws Exception {
    ...
    @Test
    public void createValidGradeHttpStudentDoesNotExist() throws Exception {
        mockMvc.perform(post("/grades")
                        .contentType(APPLICATION_JSON_UTF8)
                        .param("grade", "85.00")
                        .param("gradeType", "math")
    ...
    @Test
    public void deleteValidGradeHttpRequestNotFound() throws Exception {
    ...
    @Test
    public void deleteInValidGradeHttpRequestNotFound() throws Exception {
