...
public class GradebookControllerTest {
    ...
    public void getStudentsHttpRequest() throws Exception {
        CollegeStudent studentOne =
                new GradebookCollegeStudent("Eric", "Roby", "eric.roby@luv2code.com");
        CollegeStudent studentTwo =
                new GradebookCollegeStudent("Chad", "Darby", "chad.darbyy@luv2code.com");

        List<CollegeStudent> studentList = List.of(studentOne, studentTwo);
    ...
    public void createStudentHttpRequest() throws Exception {
        ...
        CollegeStudent verifyStudent = studentDao.findByEmailAddress(studentEmail);
